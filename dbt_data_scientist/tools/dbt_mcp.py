...
AGENT_INSTRUCTIONS = "Use the dbt MCP tools to answer the user's questions."
...
# Get the tools from the MCP toolset for use in other agents
# Note: This will be called asynchronously when needed, not during import
async def get_dbt_mcp_tools():
    """Get the tools from the MCP toolset asynchronously."""
    return await dbt_mcp_toolset.get_tools()
